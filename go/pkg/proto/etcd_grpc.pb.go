...
// UnimplementedEtcdServer must be embedded to have
...
func (UnimplementedEtcdServer) InitEtcd(context.Context, *empty.Empty) (*empty.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method InitEtcd not implemented")
}
func (UnimplementedEtcdServer) GetDatasetMetadata(context.Context, *EtcdKey) (*Dataset, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDatasetMetadata not implemented")
}
func (UnimplementedEtcdServer) mustEmbedUnimplementedEtcdServer() {}
func (UnimplementedEtcdServer) testEmbeddedByValue()              {}
...
func RegisterEtcdServer(s grpc.ServiceRegistrar, srv EtcdServer) {
	// If the following call panics, it indicates UnimplementedEtcdServer was
