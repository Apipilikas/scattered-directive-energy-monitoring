...
type MicroserviceCommunication struct {
	...
	OriginalRequest *any1.Any              `protobuf:"bytes,5,opt,name=original_request,json=originalRequest,proto3" json:"original_request,omitempty"`
...
func (x *MicroserviceCommunication) GetData() *_struct.Struct {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *MicroserviceCommunication) GetOriginalRequest() *any1.Any {
	if x != nil {
