...
// UnimplementedGenericServer must be embedded to have
...
func (UnimplementedGenericServer) InitTracer(context.Context, *ServiceName) (*empty.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method InitTracer not implemented")
}
func (UnimplementedGenericServer) mustEmbedUnimplementedGenericServer() {}
func (UnimplementedGenericServer) testEmbeddedByValue()                 {}
...
func RegisterGenericServer(s grpc.ServiceRegistrar, srv GenericServer) {
	// If the following call panics, it indicates UnimplementedGenericServer was
